...
#### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ChitatoeKid/games-wabot)
...
git clone https://github.com/ChitatoeKid/games-wabot
cd games-wabot
npm install
npm update
```
